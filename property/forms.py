...
class PropertyForm(forms.ModelForm):
    class Meta:
        model = Property
        fields = ['title', 'description', 'price', 'property_type', 'address', 'city', 'bedrooms', 'bathrooms', 'sqft', 'latitude', 'longitude']
        widgets = {
            ...
            for field in ['title', 'price', 'address', 'city', 'bedrooms', 'bathrooms', 'sqft', 'latitude', 'longitude']
        }
